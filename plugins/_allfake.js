...
handler.all = async function (m) {
	...
	try {
		...
		global.kontak2 = [
         [owner[0], await conn.getName(owner[0] + '6287780999540@s.whatsapp.net'), 'Renelz', 'https://instagram.com/renelz', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					body: "©Renelz",
					mediaUrl: sgc,
					description: 'Yukiprjkt',
					previewType: "PHOTO",
					thumbnail: await (await fetch(pp)).buffer(),
					sourceUrl: "https://instagram.com/reyuvvu",					
				}
			}
		}
		global.fakeig = {
