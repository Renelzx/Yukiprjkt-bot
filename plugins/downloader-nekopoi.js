...
let handler = async (m, { conn, usedPrefix, command, text }) => 
 {
  ...
  let res = await fetch(`https://api.itsrose.site/dewasa/nekopoi/detail?id=${text}&apikey=${global.itsrose}`)
...
Link: ${down.links[2].link}\n`
   ...
   conn.sendMessage(m.chat, { image: { url: res2.result.image }, caption: cap }, m)
}
